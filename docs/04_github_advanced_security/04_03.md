...
2. You will see findings from the `ZavaStorefront.csproj` file. If you select the finding you'll see a recommendation to update to the current .NET LTS version.
